...
const Title = ({ children }) => <Text style={{ marginTop: 20, fontSize: 20, fontWeight: 'bold' }}>{children}</Text>

const Content = ({ children }) => <Text style={{ fontSize: 15, marginTop: 10 }}>{children}</Text>
const SubContent = ({ children }) => <Text style={{ marginLeft: 10, fontSize: 15, marginTop: 10 }}>- {children}</Text>
